...
namespace MM.Engine.Test
{
    ...
    public class JsTest
    {
        ...
        {
            List<string> appList = new List<string>() { Cache.runPath + "script\\test.js", Cache.runPath + "script\\js\\test1.js" };
        ...
        public void Load()
        {
            string file = Cache.runPath + "script\\js\\test1.js";
        ...
        {
            string file = Cache.runPath + "script\\test.js";
            string fun = "Main";
            // var bl = eng.Load(file, fun);
            object param1 = 1;
            object param2 = 2;
