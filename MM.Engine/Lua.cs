...
//        public LuaEngine(string dir = null)
//        {
...
//                    // classModel += string.Format(",{0} = {0}", funName);
//                    dict.Add(funName, value);
//                }
//                //code += "\nClassModel = {" + classModel.Substring(1) + "}\n;";
//                //code += @"
//                //function NewClassModel ()
//                //    return ClassModel
//                //end";
//                Eng.DoString(code);
//                return dict["Main"]("", 1, 2, 3);

//                //var funObj = Eng.GetFunction("Main");
//                //var objs = funObj.Call("", 1, 2, 3);
//                //Debug.WriteLine(objs[0]);
//                //Debug.WriteLine("步骤2"+ funObj);
//                //if (param1 == null)
//                //{
//                //    return dyn.Main(fun);
//                //}
...
//                };
//                Eng["Engine"] = Engine;
//                dynamic dyn = Eng.LoadString(code, "Script");
//                if (param1 == null)
//                {
//                    return dyn.Main(fun);
//                }
