...
//        {
//            var fun = "";
//            var obj = CSScript.RoslynEvaluator.LoadCode("");
//            var tp = obj.GetType();
//            var funObj = tp.GetMethod(fun);
//            tp.
//            return obj = funObj.Invoke(obj, param1, param2, param3);
//           var object = CSScript.Evaluator.LoadFile("tet");
//            (new string[] { file })
